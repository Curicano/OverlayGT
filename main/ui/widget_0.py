...
class Ui_AudioWidget(object):
    def setupUi(self, AudioWidget):
        ...
        self.f_speakers.setGeometry(QtCore.QRect(0, 95, 320, 29))
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/img/img_14.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.btn_pp.setText("")
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/img/img_12.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btn_pp.setIcon(icon3)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/img/img_13.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
